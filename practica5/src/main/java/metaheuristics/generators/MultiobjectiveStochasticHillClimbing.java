...
/**
 * class that implements the Multiobjective Stochastic Hill Climbing metaheuristic.
 */
public class MultiobjectiveStochasticHillClimbing extends Generator{
	...
	@Override
	/**
	 * @brief generate a new state based on the operator number.
	...
	@Override
	/**
	 * @brief update the reference state and the list of visited states.
	 */
